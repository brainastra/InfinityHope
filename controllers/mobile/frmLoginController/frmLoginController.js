...
//     }
  ...
  resetLoginUI : function ()
  {
    	...
    	this.view.imgKonyLogo.width = "180dp";
    	this.view.imgKonyLogo.height = "20%";
  ...
  checkLoginType : function(checkDeviceReg)
  {
    ...
    if(checkDeviceReg == true){      
      ...
      else if(loginData.defaultAuthMode == "touchid" && deviceManager.isTouchIDSupported())
      {
        this.touchLoginShow();
      }
      else
  ...
  touchLoginShow : function()
  {
    ...
    this.view.flxFaceIdPopUp.setVisibility(false);
      ...
      else
      {
        ...
        kony.application.setApplicationCallbacks({onbackground: this.cancelTouchIdAuth});
        kony.application.setApplicationCallbacks({onforeground: this.showTouchIdAndroid});
      }
  ...
  showTouchIdAndroid : function(){
    var loginData = applicationManager.getNavigationManager().getCustomInfo("frmLogin");
    var deviceManager = applicationManager.getDeviceUtilManager();
    if(loginData && loginData.defaultAuthMode == "touchid" &&  deviceManager.isTouchIDSupported() && kony.application.getCurrentForm().id == "frmLogin"){
      this.view.flxPopup.setVisibility(false);
  ...
  loginActionClicks : function ()
  {
       ...
       this.view.tbxPassword.onDone = function() {
       								 ...
       								 }.bind(this); //this.btnLoginOnClick;
