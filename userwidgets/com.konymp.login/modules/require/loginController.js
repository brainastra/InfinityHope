define(function() {
    ...
    constants.DEFAULT_PROVIDER_NAME = "Username";
    ...
    return {
         ...
         */
        invokeIdentityService: function(provdidername,browserRequired) {
          this.providername = "Username";
                ...
                if (this.submitOnClick !== null && this.submitOnClick !== undefined) {
                    ...
                    if (this.validate()) {
                        if (this.providerName !== null || this.providerName !== undefined || this.providerName !== "") {
                            ...
                            this.invokeIdentityService("Username",false);
                        } else {
                            this.invokeIdentityService("Username",false);
                        }
                    }
